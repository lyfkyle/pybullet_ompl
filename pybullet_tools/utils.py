...
CUP = 'models/cup.urdf'
SQUARE = 'models/square.urdf'
BLUE_BOX = 'models/drake/objects/block_blue.urdf'
YELLOW_BOX = 'models/drake/objects/block_yellow.urdf'
BLACK_BOX = 'models/drake/objects/block_black.urdf'
...
def set_default_camera(yaw=0, pitch=-60, distance=2.5):
    # TODO: deprecate
...
def quat_diff(quat0, quat1):
    return p.getDifferenceQuaternion(quat0, quat1)
